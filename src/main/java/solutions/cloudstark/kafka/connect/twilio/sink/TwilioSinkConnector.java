...
/**
 * Entry point for Kafka Connect Twilio Sink.
 */
public class TwilioSinkConnector extends SinkConnector {
    ...
    public ConfigDef config() {
        return TwilioSinkConnectorConfig.conf();
    }
